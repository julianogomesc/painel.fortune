...
<template>
  <div class="bg-gray-200 flex flex-col justify-between h-full rounded-2xl p-8 text-black bg-[url('./images/maspireside.webp')] bg-no-repeat bg-right bg-size-[55%] lg:bg-size-[45%] 2xl:pr-48">
    <div>
      <span class="block text-gray-600 px-2 text-sm mb-3">Categorias:</span>
